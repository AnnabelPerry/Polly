...
RcppExport SEXP _Polly_Polly(SEXP region_sizeSEXP, SEXP desired_scaffoldsSEXP, SEXP SIthresholdSEXP, SEXP freq_nameSEXP, SEXP bam_vecSEXP, SEXP lookup_fileSEXP, SEXP MicroThresholdSEXP, SEXP SIOutputNameSEXP, SEXP MicroOutputNamesSEXP, SEXP PollyMicroOutputNameSEXP, SEXP FinalOutputNameSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type region_size(region_sizeSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type desired_scaffolds(desired_scaffoldsSEXP);
    Rcpp::traits::input_parameter< double >::type SIthreshold(SIthresholdSEXP);
    Rcpp::traits::input_parameter< std::string >::type freq_name(freq_nameSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type bam_vec(bam_vecSEXP);
    Rcpp::traits::input_parameter< std::string >::type lookup_file(lookup_fileSEXP);
    Rcpp::traits::input_parameter< int >::type MicroThreshold(MicroThresholdSEXP);
    Rcpp::traits::input_parameter< std::string >::type SIOutputName(SIOutputNameSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type MicroOutputNames(MicroOutputNamesSEXP);
    Rcpp::traits::input_parameter< std::string >::type PollyMicroOutputName(PollyMicroOutputNameSEXP);
    Rcpp::traits::input_parameter< std::string >::type FinalOutputName(FinalOutputNameSEXP);
    Polly(region_size, desired_scaffolds, SIthreshold, freq_name, bam_vec, lookup_file, MicroThreshold, SIOutputName, MicroOutputNames, PollyMicroOutputName, FinalOutputName);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Polly_Polly", (DL_FUNC) &_Polly_Polly, 11},
    {NULL, NULL, 0}
};
